...
// ── Password policy ──────────────────────────────────────────────────────────
// Applied wherever a doctor chooses a password: sign-up, the signed-out forgot
// password reset, and the in-app change under Profile → Security. The patient app
// carries the same rules so a household using both apps meets one standard.
//
