        ...
        Column(modifier = Modifier.fillMaxSize().padding(paddingValues)) {
            ...
            Column(
                ...
                Button(
                    ...
                    if (isCreating) {
                        CircularProgressIndicator(modifier = Modifier.padding(4.dp).height(18.dp), color = Color.White, strokeWidth = 2.dp)
                    } else {
                        Text("Submit Ticket", modifier = Modifier.padding(vertical = 6.dp))
                    }
                }
