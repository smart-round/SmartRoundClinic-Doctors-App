...
class ConfirmAppointmentUseCase(private val remote: AppointmentRepository) {
    suspend operator fun invoke(id: String): Resource<SuccessRes> = remote.confirmAppointment(id)
}
