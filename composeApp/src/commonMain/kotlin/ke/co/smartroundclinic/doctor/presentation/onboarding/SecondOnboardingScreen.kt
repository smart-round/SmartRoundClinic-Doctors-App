    ...
    Box(
        ...
        Column(
            ...
            Column(modifier = Modifier.padding(vertical = 16.dp)) {
                Text(
                    text = "Flexible Work On Your Terms",
                ...
                Text(
                    text = "Easily manage bookings, define your availability, and optimize your time for maximum productivity.",
                    maxLines = 3,
                    textAlign = TextAlign.Center,
            ...
            Image(
                ...
                contentDescription = "young female doctor as background",
                contentScale = ContentScale.FillWidth,
                modifier = Modifier
                    .fillMaxWidth()
