...
import ke.co.smartroundclinic.doctor.data.remote.dto.request.WsChatMessageReq
import ke.co.smartroundclinic.doctor.data.remote.dto.response.SupportChatMessageRes
...
import ke.co.smartroundclinic.doctor.common.Resource.Success
...
class SupportChatViewModel(
    ...
    private fun loadHistory() {
        viewModelScope.launch {
            ...
            val result = getChatHistoryUseCase(ticketId)
        ...
        wsJob = viewModelScope.launch {
            try {
                ...
                client.webSocket(
                    ...
                    // Forward queued text messages to the WebSocket
                    val sendJob = launch {
