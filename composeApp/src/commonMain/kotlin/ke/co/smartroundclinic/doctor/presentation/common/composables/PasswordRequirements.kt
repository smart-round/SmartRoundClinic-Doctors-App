...
import ke.co.smartroundclinic.doctor.common.passwordRules
            ...
            password.passwordRules().forEach { rule ->
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Icon(
                        ...
                        tint = if (rule.isMet) Green40 else MaterialTheme.colorScheme.onSurfaceVariant,
                    ...
                    Text(
                        ...
                        color = if (rule.isMet) Green40 else MaterialTheme.colorScheme.onSurfaceVariant,
                    )
                }
            }
        }
