...
object Constants {
    ...
    const val KEY_COMPLIANCE_IS_APPROVED = "key_compliance_is_approved"
    ...
    /**
     * Only images below this size get an in-flight thumbnail, because that preview is the one
     * place we must hold the bytes in memory. Anything larger shows an icon.
     */
