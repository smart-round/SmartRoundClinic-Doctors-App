...
/**
 * Shared by [rememberMinimizeCallAction] and `MainActivity.onUserLeaveHint()` — a 9:16
...
class CallPipActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_TOGGLE_AUDIO = "ke.co.smartroundclinic.doctor.action.PIP_TOGGLE_AUDIO"
        const val ACTION_END_CALL = "ke.co.smartroundclinic.doctor.action.PIP_END_CALL"
