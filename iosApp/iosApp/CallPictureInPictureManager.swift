...
/// patient-doctor video call. Built on Apple's dedicated calling-app API
/// (`AVPictureInPictureController` + `AVPictureInPictureVideoCallViewController`), not the
/// generic `AVPlayer`-based PiP.
///
